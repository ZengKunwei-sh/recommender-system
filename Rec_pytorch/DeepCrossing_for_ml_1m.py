...
from model.deepcrossing import DeepCrossingModel
...
if __name__ == '__main__':
	...
	embed_dim = 8
	dc = DeepCrossingModel(field_dims, embed_dim, [5, 5], 0.2)

	loss = BCELoss(reduction='sum').to('cuda')
	optimizer = torch.optim.SGD(dc.parameters(), lr=0.01)


	epochs = 3
	train_and_eval(dc, train_loader, test_loader, epochs, loss, optimizer)